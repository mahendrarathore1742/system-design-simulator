  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "app-server", x: 500, y: 250 },
        { componentId: "cache", x: 500, y: 100 },
        { componentId: "message-queue", x: 500, y: 420 },
        { componentId: "sql-db", x: 700, y: 200 },
        { componentId: "nosql-db", x: 700, y: 370 },
        { componentId: "monitoring", x: 850, y: 250 },
      ],
      edges: [
        { source: "dns", target: "load-balancer" },
  ...
  },
  {
    ...
    hints: [
      ...
      },
      {
        title: "OT vs CRDT",
        content:
          "OT transforms operations against concurrent edits (used by Google Docs). CRDTs merge states without a central server (used by Figma). OT is simpler; CRDTs are more robust offline.",
      },
      {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "nosql-db", x: 720, y: 370 },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "search", x: 720, y: 380 },
  ...
  },
  {
    ...
    referenceSolution: {
      nodes: [
        ...
        { componentId: "nosql-db", x: 620, y: 200 },
